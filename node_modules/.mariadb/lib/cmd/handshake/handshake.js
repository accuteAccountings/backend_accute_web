...
const InitialHandshake = require('.mariadb/lib/cmd/handshake/initial-handshake');
const ClientHandshakeResponse = require('.mariadb/lib/cmd/handshake/client-handshake-response');
  ...
  static pluginHandler(
    ...
    switch (pluginName) {
      case 'mysql_native_password':
        pluginAuth = require('.mariadb/lib/cmd/handshake/auth/native-password-auth.js');
        break;

      case 'mysql_clear_password':
        pluginAuth = require('.mariadb/lib/cmd/handshake/auth/clear-password-auth.js');
        break;

      case 'client_ed25519':
        pluginAuth = require('.mariadb/lib/cmd/handshake/auth/ed25519-password-auth.js');
        break;

      case 'dialog':
        pluginAuth = require('.mariadb/lib/cmd/handshake/auth/pam-password-auth.js');
        break;
