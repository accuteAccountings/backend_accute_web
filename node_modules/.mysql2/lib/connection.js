...
const Queue = require('.mysql2/lib/node_modules/denque');
const SqlString = require('.mysql2/lib/node_modules/sqlstring');
const LRU = require('.mysql2/lib/node_modules/lru-cache');

const PacketParser = require('.mysql2/lib/packet_parser.js');
const Packets = require('.mysql2/lib/packets/index.js');
const Commands = require('.mysql2/lib/commands/index.js');
  ...
  _resolveNamedPlaceholders(options) {
    ...
    if (this.config.namedPlaceholders || options.namedPlaceholders) {
      if (convertNamedPlaceholders === null) {
        convertNamedPlaceholders = require('.mysql2/lib/node_modules/named-placeholders')();
      }
